<template>
  <div class="box">
    <div class="main">
      ...
      <div >
        <span
          :class="item.status === '0' ? 'seat-selectable' : (item.status === '1' ? 'seat-selected' : 'seat-sold')"
          v-for="(item, index) in seats" :key="index">
        </span>
      </div>
    </div>
